...
# in 
meta_path = '/ceph/dataset/LJSpeech-1.1/metadata.csv'
# 超参数会指定采样率16k, 外部磁盘就不用降了
wav_dir = '/ceph/dataset/LJSpeech-1.1/wavs'

# out1 
ppg_dir = './CN-PPG_ljspeech/ppg_ForcePPG'
mfcc_dir = './CN-PPG_ljspeech/mfcc_ForcePPG'
mel_dir = './CN-PPG_ljspeech/mel_ForcePPG'
spec_dir = './CN-PPG_ljspeech/spec_ForcePPG'
rec_wav_dir = './CN-PPG_ljspeech/rec_wavs_ForcePPG'
...
out_meta_path = './CN-PPG_ljspeech/meta_list_ForcePPG.txt'
...
def main():
    ...
    # CSV: LJ001-0001|Printing|Printing
